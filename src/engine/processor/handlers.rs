use crate::engine::compositor::{should_block_invalid_input, Compositor};
use crate::engine::keys::VirtualKey;
use crate::engine::pipeline::lookup;
use crate::engine::processor::commands;
use crate::engine::processor::utils::*;
use crate::engine::processor::{Action, Command, FilterMode};
...
pub fn handle_punctuation(ctx: &mut EngineContext, key: VirtualKey, shift_pressed: bool) -> Action {
    use crate::engine::processor::punctuation;
